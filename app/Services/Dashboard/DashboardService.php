...
class DashboardService
{
    ...
    private function buildMetrics(?int $employeeId, array $range): array
    {
        ...
        return [
            ...
            'demos_scheduled' => $demoMetrics['demos_scheduled'],
            'demos_completed' => $demoMetrics['demos_completed'],
            'demos_rescheduled' => $demoMetrics['demos_rescheduled'],
            'demos_cancelled' => $demoMetrics['demos_cancelled'],
            'missed_demos' => $demoMetrics['missed_demos'],
            'demos_purchased' => $demoMetrics['demos_purchased'],
            'demo_conversion_rate' => $demoMetrics['demo_conversion_rate'],
