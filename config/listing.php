...
return [
    ...
    'ca_masters' => [
        ...
        'max_all' => 1000,
        'sortable' => ['ca_id', 'firm_name', 'ca_name', 'email_id', 'sales_remarks', 'remarks_1', 'remarks_2', 'remarks_3', 'status', 'rating', 'team_size', 'created_at', 'updated_at', 'team_members_count', 'last_activity_at'],
        'search_columns' => ['firm_name', 'ca_name', 'mobile_no', 'alternate_mobile_no', 'email_id', 'sales_remarks', 'remarks_1', 'remarks_2', 'remarks_3', 'gst_no'],
        'search_relations' => [
            'city' => ['city_name'],
            'state' => ['state_name'],
        ...
        'filters' => [
            ...
            'firm_name' => 'ilike',
            'ca_name' => 'ilike',
            'mobile_no' => 'mobile_ilike',
            'alternate_mobile_no' => 'mobile_ilike',
            'email_id' => 'ilike',
            'sales_remarks' => 'ilike',
            'remarks_1' => 'ilike',
            'remarks_2' => 'ilike',
