...
window.CAPages = (function () {
    ...
    return '<div class="mgr-dashboard">' +
      ...
      '<section id="mgr-followup-automation-panel" class="mgr-panel card dash-section">' +
        ...
        '<div class="dash-fu-kpi-grid">' +
          '<button type="button" class="dash-fu-kpi dash-fu-kpi--nav" data-dash-nav data-nav-page="followups" data-followup-filter="today" data-kpi="Today" title="Open today\'s follow-ups" aria-label="Open today\'s follow-ups"><span class="dash-fu-kpi__label">Today</span><strong class="dash-fu-kpi__value" id="mgr-fu-today">—</strong></button>' +
          '<button type="button" class="dash-fu-kpi dash-fu-kpi--nav" data-dash-nav data-nav-page="followups" data-followup-filter="pending" data-kpi="Upcoming" title="Open upcoming follow-ups" aria-label="Open upcoming follow-ups"><span class="dash-fu-kpi__label">Upcoming</span><strong class="dash-fu-kpi__value" id="mgr-fu-upcoming">—</strong></button>' +
          '<button type="button" class="dash-fu-kpi dash-fu-kpi--nav" data-dash-nav data-nav-page="followups" data-followup-filter="completed" data-kpi="Completed Today" title="Open completed follow-ups" aria-label="Open completed follow-ups"><span class="dash-fu-kpi__label">Completed Today</span><strong class="dash-fu-kpi__value" id="mgr-fu-completed-today">—</strong></button>' +
          '<button type="button" class="dash-fu-kpi dash-fu-kpi--nav" data-dash-nav data-nav-page="followups" data-followup-filter="overdue" data-kpi="Missed" title="Open missed follow-ups" aria-label="Open missed follow-ups"><span class="dash-fu-kpi__label">Missed</span><strong class="dash-fu-kpi__value" id="mgr-fu-missed">—</strong></button>' +
          '<button type="button" class="dash-fu-kpi dash-fu-kpi--danger dash-fu-kpi--nav" data-dash-nav data-nav-page="followups" data-followup-filter="overdue" data-kpi="Overdue" title="Open overdue follow-ups" aria-label="Open overdue follow-ups"><span class="dash-fu-kpi__label">Overdue</span><strong class="dash-fu-kpi__value" id="mgr-fu-overdue">—</strong></button>' +
          '<button type="button" class="dash-fu-kpi dash-fu-kpi--nav" data-dash-nav data-nav-page="analytics" data-kpi="Follow-up Conv." title="Open follow-up conversion analytics" aria-label="Open follow-up conversion analytics"><span class="dash-fu-kpi__label">Follow-up Conv.</span><strong class="dash-fu-kpi__value" id="mgr-fu-conversion">—</strong></button>' +
          '<button type="button" class="dash-fu-kpi dash-fu-kpi--nav" data-dash-nav data-nav-page="analytics" data-kpi="Demo Conv." title="Open demo conversion analytics" aria-label="Open demo conversion analytics"><span class="dash-fu-kpi__label">Demo Conv.</span><strong class="dash-fu-kpi__value" id="mgr-fu-demo-conversion">—</strong></button>' +
        '</div>' +
  ...
  function caMasterColumnDefinitions() {
    return [
      ...
      { key: 'remarks_1', label: 'Remarks 1', required: false, defaultVisible: true, filterKey: 'remarks_1', filterPlaceholder: 'search', colCls: 'crm-col-remarks cam-col-remarks', thCls: 'crm-th-remarks cam-col-remarks' },
      { key: 'remarks_2', label: 'Remarks 2', required: false, defaultVisible: true, filterKey: 'remarks_2', filterPlaceholder: 'search', colCls: 'crm-col-remarks cam-col-remarks', thCls: 'crm-th-remarks cam-col-remarks' },
      { key: 'remarks_3', label: 'Remarks 3', required: false, defaultVisible: true, filterKey: 'remarks_3', filterPlaceholder: 'search', colCls: 'crm-col-remarks cam-col-remarks', thCls: 'crm-th-remarks cam-col-remarks' },
      ...
      { key: 'last_activity', label: 'Last Activity', required: false, defaultVisible: true, sortField: 'last_activity_at', filterKey: 'assigned_date', filterType: 'date-nav', colCls: 'crm-col-last-activity', thCls: 'crm-th-last-activity' },
