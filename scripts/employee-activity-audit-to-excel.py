...
def main():
    ...
    headers = [
        ...
        "Total Demos Booked", "Still Scheduled (Open)", "Completed (from booked)", "Completion %",
        "Missed", "Follow-ups Total",
    ...
    for emp in data["employees"]:
        ...
        rows.append([
            ...
            s.get("demos_total_booked", s.get("demos_scheduled_created", 0)),
            s.get("demos_still_scheduled", s.get("demos_still_open", 0)),
            s.get("demos_completed_from_booked", s.get("demos_completed", 0)),
            s.get("demo_completion_from_booked_pct", 0),
            s.get("demos_missed_from_booked", s.get("demos_missed", 0)),
            s["followups_total"],
    ...
    rows.append([
        ...
        "",
        "",
        gt.get("demos_total_booked", gt.get("demos_scheduled_created", 0)),
        gt.get("demos_still_scheduled", 0),
        gt.get("demos_completed_from_booked", gt.get("demos_completed", 0)),
        "",
        gt.get("demos_missed_from_booked", 0),
