...
<script src="{{ asset('crm-ui/src/components/demo-calendar-data.js') }}"></script>
<script src="{{ asset('crm-ui/src/components/demo-calendar-page.js') }}"></script>
<script src="{{ asset('crm-ui/src/components/report-analytics.js') }}"></script>
