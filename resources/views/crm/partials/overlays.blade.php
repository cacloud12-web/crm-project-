  ...
  <div id="detail-drawer" class="ca-modal detail-drawer" role="dialog" aria-modal="true" aria-labelledby="detail-drawer-title">
    <div class="ca-modal-panel ca-modal-panel-md detail-drawer__panel">
      <div class="ca-modal-header detail-drawer__header">
        ...
        <button id="detail-drawer-close" class="ca-modal-close shrink-0" type="button" aria-label="Close"><i data-lucide="x" class="h-5 w-5"></i></button>
      </div>
  ...
  <div id="modal-followup" class="ca-modal" role="dialog" aria-modal="true" aria-labelledby="followup-title">
    <div class="ca-modal-panel ca-modal-panel-lg">
      ...
      <form id="form-followup" class="ca-modal-body space-y-4">
        ...
        <div><label class="form-label">Follow-up Type</label><select name="followup_type" class="input-field"><option>Call Status</option><option>Demo Scheduled</option><option>Demo Completed</option><option>Details Shared</option><option>Negotiation</option><option>Not Interested</option><option>Do Not Disturb</option><option>Follow Up Reminder</option><option>Follow Up Scheduled</option></select></div>
